...
describe Quartz::Window do
  ...
  describe "#initialize" do
    ...
    it "each window gets a unique handle" do
      w1 = WidgetFactory.window("A")
      w2 = WidgetFactory.window("B")
      w3 = WidgetFactory.window("C")
  ...
  describe "#add_control and #children" do
    ...
    it "overwrites previous parent and updates children collections" do
      w1 = WidgetFactory.window("Window 1")
      w2 = WidgetFactory.window("Window 2")
  ...
  describe "#menu_bar=" do
    it "attaches a menu bar with one item without error" do
      window = WidgetFactory.window
    ...
    it "returns self for chaining" do
      window = WidgetFactory.window
      bar = Quartz::MenuBar.new
      (window.menu_bar = bar).should be(window)
    end
  end
end
